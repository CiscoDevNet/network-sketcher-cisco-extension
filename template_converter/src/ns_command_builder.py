...
TEMPLATE FILE — copy this into your new converter's ``src/`` UNCHANGED. The
ONLY line you should ever need to touch is the ``platform_stencil_mapper``
import below — repoint it at your new converter's own stencil-mapper module
name. The body is identical across every converter in this repo: any
``NSModel``, built by any platform's mapper, serialises the same way.
...
from .platform_stencil_mapper import NS_CLOUD, NS_PC, NS_PHONE, NS_SERVER, StencilMapping
