...
``.ns_model`` / ``.nd_stencil_mapper``. The body is identical — any NSModel,
whether built by the physical or logical ND mapper, serialises the same way.
...
from .netbox_stencil_mapper import NS_CLOUD, NS_PC, NS_PHONE, NS_SERVER, StencilMapping
